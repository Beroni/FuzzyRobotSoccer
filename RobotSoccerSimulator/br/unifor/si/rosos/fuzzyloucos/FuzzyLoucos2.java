...
public class FuzzyLoucos2 implements Team{
	private static class UsSensors {
		public static final int FRONT = 0;
		public static final int LEFT = 1;
		public static final int BACK = 2;
		public static final int RIGHT = 3;
		public int qtdJogs=0;
	}
	...
	class Zidane extends RobotBasic{
		...
		protected void initializeSensors(GameSimulator game){
			...
			SensorAll sensor_all = new SensorAll(game,this);
			registerSensor(sensor_all, "ALL");
		...
		public void logicaFuzzyLeft() {
			
			String filename = "br/unifor/si/rosos/fuzzyloucos/logicaLeft.fcl";
			...
			// Set inputs
			float ballX = ball.position.x-posX;
			float ballY = ball.position.y-posY;
			
			
			float distBola = calculaDists(this.getRealPosition(),ball.position);
			
			fb.setVariable("posX", posX);
			fb.setVariable("posY", posY);
			fb.setVariable("ballX", ballX);
			fb.setVariable("ballY", ballY);
			fb.setVariable("speedX", this.realSpeedX);
			fb.setVariable("speedY", this.realSpeedY);
			fb.setVariable("distBola", distBola);
		...
		public void logicaFuzzyRight() {
			...
			String filename = "br/unifor/si/rosos/fuzzyloucos/logicaRight.fcl";
			FIS fis = FIS.load(filename, true);
...
//	    }
	...
	class Buffon extends RobotBasic{
		Buffon(GameSimulator s){
			super(s);			
		}
		...
		public void logicaFuzzy() {
			...
			String filename = "br/unifor/si/rosos/fuzzyloucos/logicaGoleiroDireita.fcl";
			FIS fis = FIS.load(filename, true);
