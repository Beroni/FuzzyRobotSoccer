...
public class Fuzzdeu extends RobotBasic {
	...
	private void fuzzyLogic() {
		...
		String rule_game_strategy = "br/unifor/si/rosos/Fuzzdeu/rule_game_strategy.fcl";
		String rule_player_velocity = "br/unifor/si/rosos/Fuzzdeu/rule_player_velocity.fcl";
		...
		//Game Strategy
		double time_left = (120 - gameSimulator.getTime()) / 12;
		...
		this.setSpeed((float) playerVelocity.getValue() );
