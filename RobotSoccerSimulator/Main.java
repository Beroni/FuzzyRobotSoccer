...
import br.unifor.si.rosos.Fuzzdeu.FuzzDeuTeam;
import br.unifor.si.rosos.breno_pedro_team.MonkeyTeam;
import br.unifor.si.rosos.fuzhoda.FuzRoDaTeam;
import br.unifor.si.rosos.fuzzyleiros.robot.FuzzyleirosTeam;
import br.unifor.si.rosos.fuzzyleiros.robot.TesteTeam;
import br.unifor.si.rosos.fuzzyloucos.FuzzyLoucos2;
import br.unifor.si.rosos.testeTeam.*;
...
public class Main extends PApplet{
    ...
    public void settings(){
        ...
        //controller.getSimulator().setFieldSize(3.15f, 5.04f);
